    ...
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                @endif
                <form id="demo-form2" method='post' action="{{ route('insurancecompany.update', ['insurancecompany' => $insurancecompany->id]) }}" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" autocomplete="off">
                {{csrf_field()}}
                @method('PUT')
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="Name">Name <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6">
                            <input type="text" id="name" name="name" value="{{ $insurancecompany->name }}" class="form-control">
                            @if ($errors->has('name'))
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                        <div class="checkbox">
                            <label><input type="checkbox" id="is_active" name="is_active" {{ $insurancecompany->is_active ? 'checked' : '' }} class="flat"></label>
