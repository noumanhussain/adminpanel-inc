@extends('layouts.app')
@section('title','Edit Car Repair Coverage')
@section('content')
<div class="row">
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                @endif
                <form id="demo-form2" method='post' action="{{ route('carrepaircoverage.update', ['carrepaircoverage' => $carrepaircoverage->id]) }}" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" autocomplete="off">
                {{csrf_field()}}
                @method('PUT')
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="text">Text En <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6">
                            <input type="text" id="text" name="text" value="{{ $carrepaircoverage->text }}" class="form-control">
                            @if ($errors->has('text'))
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="text" id="text_ar" name="text_ar" value="{{ $carrepaircoverage->text_ar }}" class="form-control">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="number" id="text_ar" name="sort_order" value="{{ $carrepaircoverage->sort_order }}" class="form-control">
