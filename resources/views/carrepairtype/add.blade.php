@extends('layouts.app')
@section('title','Add Car Repair Type')
@section('content')
<div class="row">
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Create Car Repair Type</h2>
            ...
            <div class="x_content">
                ...
                @endif
                <form id="demo-form2" method='post' action="{{ url('claim/carrepairtype') }}" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" autocomplete="off">
                {{csrf_field()}}
