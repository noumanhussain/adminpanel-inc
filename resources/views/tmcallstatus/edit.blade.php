@extends('layouts.app')
@section('title','Edit TM Call Status')
@section('content')
<div class="row">
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Edit TM Call Status</h2>
            ...
            <div class="x_content">
                ...
                @endif
                <form id="demo-form2" method='post' action="{{ route('tmcallstatus.update', ['tmcallstatus' => $tmcallstatus->id]) }}" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" autocomplete="off">
                {{csrf_field()}}
                @method('PUT')
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="code">Code <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6">
                            <input type="text" id="code" name="code" value="{{ $tmcallstatus->code }}" class="form-control" maxlength="100">
                            @if ($errors->has('code'))
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="text" id="text" name="text" value="{{ $tmcallstatus->text }}" class="form-control" maxlength="100">
                            @if ($errors->has('text'))
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="text" id="text_ar" name="text_ar" value="{{ $tmcallstatus->text_ar }}" class="form-control" maxlength="100">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="number" id="sort_order" name="sort_order" value="{{ $tmcallstatus->sort_order }}" class="form-control" onKeyPress="if(this.value.length==5) return false;">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                        <div class="checkbox">
                            <input type="checkbox" {{ $tmcallstatus->is_active ? 'checked' : '' }} class="flat" id='is_active' name='is_active'>
                        </div>
                        </div>
                    </div>
