    ...
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                @endif
                <form id="demo-form2" method='post' action="{{ route('paymentmode.update', ['paymentmode' => $paymentmode->id]) }}" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" autocomplete="off">
                {{csrf_field()}}
                @method('PUT')
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input type="text" id="name" name="name" value="{{ $paymentmode->name }}" class="form-control">
                            @if ($errors->has('name'))
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                        <div class="checkbox">
                            <label><input type="checkbox" id="is_active" name="is_active" {{ $paymentmode->is_active ? 'checked' : '' }} class="flat"></label>
