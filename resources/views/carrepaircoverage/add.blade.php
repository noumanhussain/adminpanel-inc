@extends('layouts.app')
@section('title','Add Car Repair Coverage')
@section('content')
<div class="row">
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Create Car Repair Coverage</h2>
            ...
            <div class="x_content">
                ...
                @endif
                <form id="demo-form2" method='post' action="{{ url('claim/carrepaircoverage') }}" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" autocomplete="off">
                {{csrf_field()}}
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="checkbox">
                                <input type="checkbox" class="flat" id='is_active' name='is_active' value="1">
                            </div>
                        </div>
                    </div>
